...
Revision ID: 1b2d378c03e1
Revises: 
Create Date: 2021-11-06 21:36:40.263393
...
def upgrade():
    ...
    sa.Column('player_hash', sa.Integer(), nullable=False),
    sa.Column('world_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['player_hash'], ['player.hash'], ),
    sa.ForeignKeyConstraint(['realm_id'], ['realm.id'], ),
    sa.ForeignKeyConstraint(['world_id'], ['world.id'], ),
    sa.PrimaryKeyConstraint('realm_id', 'player_hash')
    )
