...
Revision ID: 038fe58464f9
Revises: 
Create Date: 2021-10-17 23:13:14.038578
...
def upgrade():
    ...
    sa.Column('squad_config_index', sa.Integer(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('realm_id', 'hash')
    )
    op.create_index(op.f('ix_basic_account_sid'), 'basic_account', ['sid'], unique=False)
    op.create_index(op.f('ix_basic_account_username'), 'basic_account', ['username'], unique=False)
    ...
    sa.PrimaryKeyConstraint('itemgroup_id', 'id')
    )
