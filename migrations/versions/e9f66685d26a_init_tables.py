...
Revision ID: e9f66685d26a
Revises: 
Create Date: 2021-09-28 03:33:02.829722
...
def upgrade():
    ...
    sa.Column('blockx', sa.Integer(), nullable=True),
    sa.Column('blocky', sa.Integer(), nullable=True),
    ...
    sa.Column('order_moving', sa.Boolean(), nullable=True),
    sa.Column('order_target', sa.String(length=32), nullable=True),
    sa.Column('order_class', sa.Integer(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('hash', 'realm_id')
    )
