...
Revision ID: f2589ec07e81
Revises: 
Create Date: 2021-10-10 02:32:32.876602
...
def upgrade():
    ...
    op.create_index(op.f('ix_account_sid'), 'account', ['sid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_account_sid'), table_name='account')
